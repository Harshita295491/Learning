...
import MyReimbursementList from "./ReimbursementComponents/Reimbursement/MyReimbursementList"
import ReimbursementRequest from "./ReimbursementComponents/Reimbursement/ReimbursementRequest"
...
const ProfileNavigation = () => {
  ...
  const sidebarItems = [
        { label: "My Reimbursement", component: "MyReimbursementList" },
        { label: "Reimbursement Request", component: "ReimbursementRequest" },    
  ];
  ...
  const renderComponent = () => {
    switch (activeComponent) {
        ...
        case "MyReimbursementList":
        return <div><MyReimbursementList/></div>;
      case "ReimbursementRequest":
        return <div><ReimbursementRequest/></div>;
      default:
